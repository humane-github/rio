...
public class FaceDetectorConfig extends ConfigBase {
    ...
    /** wakeupの使用 */
    private Boolean wakeupFlg = false;
    ...
    public FaceDetectorConfig() {
        // 実行周期のデフォルト値を500ミリ秒に設定
        this.interval = 500000L;
    }
    ...
    /**
     * wakeupFlgを取得する。
     * @return wakeupFlg wakeupFlg。
     */
	public Boolean getWakeupFlg() {
		return wakeupFlg;
	}

	/**
     * wakeupFlgを設定する。
     * @param wakeupFlg wakeupFlg.
     */
	public void setWakeupFlg(Boolean wakeupFlg) {
		this.wakeupFlg = wakeupFlg;
	}
